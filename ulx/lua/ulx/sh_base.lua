...
function ulx.help( ply )
	...
	ULib.console( ply, "all, '^' to target yourself, '@' for target your picker, '#<group>' to target users in a specific" )
	ULib.console( ply, "group, and '%<group>' to target users with access to the group (inheritance counts). IE," )
